		...
		<section
			...
			<div className="relative z-10 px-6 text-center">
				...
				<motion.p
					...
					Flexible lending solutions designed to help individuals and businesses
					achieve their goals with competitive rates, fast approvals, and
					personalized financial support every step of the way.
				</motion.p>
				...
				<motion.div
					...
					<div className="flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-6 py-3 backdrop-blur-md">
						...
						<span className="text-amber-400">Loans</span>
					</div>
				</motion.div>
			</div>
