				...
				<div className="mx-auto max-w-7xl px-6">
					<div className="grid gap-12 lg:grid-cols-2">
						...
						<motion.div
							...
							<p className="mt-5 leading-8 text-gray-600">
								Choose from working capital loans, commercial term loans, lines
								of credit, equipment financing, and customized cash-management
					...
					<motion.div
						...
						<p className="mx-auto mt-6 max-w-3xl text-lg leading-9 text-emerald-50">
							From startups to established enterprises, we're committed to
							helping businesses thrive through flexible lending, commercial
							banking solutions, and expert financial guidance.
						</p>
